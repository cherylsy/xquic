...
xqc_int_t  xqc_setup_crypto_ctx(xqc_connection_t * conn,
...
int xqc_conn_install_initial_rx_keys(xqc_connection_t *conn,
    uint8_t *key, size_t keylen,
    uint8_t *iv, size_t ivlen,
...
//  return ZERO if success 
int xqc_conn_install_initial_tx_keys(xqc_connection_t *conn,
    uint8_t *key, size_t keylen,
    uint8_t *iv, size_t ivlen,
    uint8_t *pn, size_t pnlen);
...
// return ZERO if success 
int xqc_conn_install_early_keys(xqc_connection_t *conn,
...
//  return ZERO if success 
int xqc_conn_install_handshake_rx_keys(xqc_connection_t *conn,
    const uint8_t *key, size_t keylen,
    const uint8_t *iv, size_t ivlen,
    const uint8_t *pn, size_t pnlen);
...
// return ZERO if success 
int xqc_conn_install_handshake_tx_keys(xqc_connection_t *conn,
    const uint8_t *key, size_t keylen,
    const uint8_t *iv, size_t ivlen,
    const uint8_t *pn, size_t pnlen);
...
// return ZERO if success 
int xqc_conn_install_rx_keys(xqc_connection_t *conn,
    const uint8_t *key, size_t keylen,
    const uint8_t *iv, size_t ivlen,
    const uint8_t *pn, size_t pnlen);
...
// return ZERO if success 
int xqc_conn_install_tx_keys(xqc_connection_t *conn,
    const uint8_t *key, size_t keylen,
    const uint8_t *iv, size_t ivlen,
    const uint8_t *pn, size_t pnlen);
...
// return ZERO if success 
int xqc_update_traffic_secret(uint8_t *dest, size_t destlen,
...
// return ZERO if success 
int xqc_conn_update_rx_key(xqc_connection_t *conn,
...
// return ZERO if success 
int xqc_conn_update_tx_key(xqc_connection_t *conn,
    const uint8_t *key, size_t keylen, const uint8_t *iv, size_t ivlen);
...
xqc_int_t xqc_derive_packet_protection(const xqc_tls_context_t *ctx,
    const uint8_t *secret, size_t secretlen,
    uint8_t *key, size_t *keylen,
    uint8_t *iv, size_t *ivlen,
    uint8_t *hp, size_t *hplen,
