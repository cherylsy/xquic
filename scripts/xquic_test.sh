...
function do_compile() {
    ...
    if [[ $1 == "XQC_OPENSSL_IS_BORINGSSL" ]]; then
        ...
        cmake -DXQC_OPENSSL_IS_BORINGSSL=1 -DXQC_ENABLE_TESTING=1 -DXQC_PRINT_SECRET=1 -DXQC_TEST_MP=1 -DXQC_SUPPORT_SENDMMSG_BUILD=1 -DXQC_ENABLE_EVENT_LOG=1 ..
    fi

    #turn on Code Coverage
    cmake -DGCOV=on -DCMAKE_BUILD_TYPE=Debug -DXQC_ENABLE_TESTING=1 -DXQC_PRINT_SECRET=1 -DXQC_TEST_MP=1 -DXQC_SUPPORT_SENDMMSG_BUILD=1 -DXQC_ENABLE_EVENT_LOG=1 ..
